  ...
  const createModal = () => {
    ...
    modal.innerHTML = `
      ...
      <div id="modal-content" style="height: calc(100% - 20px); overflow-y: auto; padding: 20px 35px 20px 20px; scrollbar-width: thin; scrollbar-color: #cbd5e0 #f8f9fa;">
        ...
        <h2 style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, sans-serif; margin-bottom: 15px; color: #1a202c; font-size: 24px; text-align: center; font-weight: 700;">Gimme That GEMBA</h2>
        <p style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; text-align: center; color: #4a5568; margin-bottom: 25px; padding: 0 20px; font-size: 14px; line-height: 1.5; border-bottom: 2px solid rgba(0,0,0,0.06); padding-bottom: 20px;">Please make sure you're on the full "Route" view before running. Do not interact with the page until progress is complete. Once complete you may move the modal window around and resize it as needed. Thank you.</p>
        ...
        <div id="progress-section" style="margin-bottom: 30px; display: none;">
    ...
    startBtn.addEventListener("click", async () => {
        ...
        try {
          ...
          startBtn.addEventListener("mouseover", () => {
            ...
            startBtn.style.boxShadow = "0 6px 8px rgba(76, 175, 80, 0.25)";
          });
