(async function () {
  const createModal = () => {
    ...
    // Create modal sections with HTML content
    const daSelectionSection = document.createElement("div");
    daSelectionSection.id = "da-selection-section";
    daSelectionSection.style.display = "none";
    daSelectionSection.style.marginBottom = "30px";
    daSelectionSection.innerHTML = `
    ...
    const routeDetailsSection = document.createElement("div");
    routeDetailsSection.id = "route-details-section";
    routeDetailsSection.style.display = "none";
    routeDetailsSection.style.marginBottom = "30px";
    ...
    const dspProgressSection = document.createElement("div");
    dspProgressSection.id = "dsp-progress-section";
    dspProgressSection.style.display = "none";
    dspProgressSection.style.marginBottom = "30px";
    dspProgressSection.innerHTML = `
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
    ...
    modal.innerHTML = `
      ...
      ${daSelectionSection.outerHTML}
      ${routeDetailsSection.outerHTML}
      ${dspProgressSection.outerHTML}
    `;
    ...
    modal.appendChild(routeDetailsSection);
    modal.appendChild(dspProgressSection);

    // Navigation setup after modal content is added
